let Framer = {
    ...
    let Tracker = {
        ...
        isInsideOfSmallCircle: function (e) {
            let x = Math.abs(e.pageX - this.scene.cx - this.scene.coord.left);
            let y = Math.abs(e.pageY - this.scene.cy - this.scene.coord.top);
    ...
    let Scene = {
        ...
        calculateSize: function () {
            ...
            let size = Math.max(this.minSize, 1);
    ...
    var Controls = {
        ...
        initTimeHandler: function () {
            let that = this;
            setTimeout(function () {
                let rawTime = parseInt(Player.context.currentTime || 0);
                let secondsInMin = 60;
        ...
        drawPic: function () {
            ...
            this.context.lineWidth = 1;
            let x = Tracker.r / Math.sqrt(Math.pow(Math.tan(Tracker.angle), 2) + 1);
            let y = Math.sqrt(Tracker.r * Tracker.r - x * x);
